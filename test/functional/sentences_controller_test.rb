...
class SentencesControllerTest < ActionController::TestCase
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post :create, sentence: { author_id: @sentence.author_id, content: @sentence.content, length: @sentence.length, story_id: @sentence.story_id }
    end
  ...
  test "should update sentence" do
    put :update, id: @sentence, sentence: { author_id: @sentence.author_id, content: @sentence.content, length: @sentence.length, story_id: @sentence.story_id }
    assert_redirected_to sentence_path(assigns(:sentence))
  end
